...
O banco `database/casa-aurora.db` será criado automaticamente. As categorias e os 150 produtos serão sincronizados a partir de `public/menu-data.js`.
